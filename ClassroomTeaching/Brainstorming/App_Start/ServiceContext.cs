...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(LINDGE.PARA.Translayer.ClassroomTeaching.Brainstorming.WebAPI.ServiceContext), "Init")]
[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(LINDGE.PARA.Translayer.ClassroomTeaching.Brainstorming.WebAPI.ServiceContext), "InitOver")]
    ...
    public static class ServiceContext
    {
        ...
        private static void RegisterRoute(HttpConfiguration config)
        {
            ...
            config.Routes.MapHttpRoute(
                name: "DefaultApi",
                routeTemplate: "api/{controller}/{id}/{receptor}",
                defaults: new { id = RouteParameter.Optional,receptor = RouteParameter.Optional }
            );
            config.Routes.MapHttpRoute(
                name: "Trace",
                routeTemplate: "Trace",
