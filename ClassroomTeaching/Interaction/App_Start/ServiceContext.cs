...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(LINDGE.PARA.Translayer.ClassroomTeaching.Interaction.WebAPI.ServiceContext), "Init")]
[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(LINDGE.PARA.Translayer.ClassroomTeaching.Interaction.WebAPI.ServiceContext), "InitOver")]
        ...
        private static void RegisterRoute(HttpConfiguration config)
        {
            ...
            config.Routes.MapHttpRoute(
                ...
                { 
                    ...
                    receptor = RouteParameter.Optional
                }
            );
            config.Routes.MapHttpRoute(
                name: "Trace",
